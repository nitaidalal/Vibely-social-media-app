...
const Navbar = () => {
  ...
  return (
    <div className="w-[100%] sm:w-[90%] lg:w-[40%] h-16 bg-gradient-to-r from-violet-600/80 to-fuchsia-600/80  border border-white/10 shadow-2xl backdrop-blur-sm  text-white fixed bottom-2 md:bottom-4  sm:rounded-full flex justify-around items-center z-50 px-4">
      {/* Home */}
      <button
        onClick={() => navigate("/")}
