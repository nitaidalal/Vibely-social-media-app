...
import { getAllStory, getStoryByUsername, uploadStory, deleteStory } from "../controllers/story.controller.js";

const storyRouter = express.Router();

storyRouter.post("/upload", authMiddleware, upload.single("media"), handleMulterError, uploadStory);
storyRouter.delete("/delete/:storyId", authMiddleware, deleteStory);
